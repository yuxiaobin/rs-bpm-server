...
CREATE TABLE `wf_awt` (
	...
	`HIST_ID_PRE` VARCHAR(50) NULL DEFAULT NULL,
	`ASSIGNER_ID` VARCHAR(50) NOT NULL,
	`awt_begin` DATETIME NULL DEFAULT NULL,
	`awt_end` DATETIME NULL DEFAULT NULL,
	`awt_alarm` DATETIME NULL DEFAULT NULL,
	`awt_title` VARCHAR(50) NULL DEFAULT NULL,
	`awt_summary` VARCHAR(100) NULL DEFAULT NULL,
