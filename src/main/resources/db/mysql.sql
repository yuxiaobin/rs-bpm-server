...
CREATE DATABASE IF NOT EXISTS `mybatis-plus` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `mybatis-plus`;
...
CREATE TABLE IF NOT EXISTS `wf_awt` (
  `wf_awt_id` varchar(50) NOT NULL,
  `INST_ID` varchar(50) NOT NULL,
  `TASK_ID_CURR` varchar(50) NOT NULL,
  `HIST_ID_PRE` varchar(50) DEFAULT NULL,
  ...
  `awt_title` varchar(50) DEFAULT NULL,
  `awt_summary` varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `wf_instance` (
  ...
  `CURR_ASSIGNERS` varchar(500) DEFAULT NULL,
  `CREATED_BY` varchar(50) NOT NULL,
  `CREATED_DT` datetime NOT NULL,
  `UPDATED_BY` varchar(50) DEFAULT NULL,
  `UPDATED_DT` datetime DEFAULT NULL,
...
CREATE TABLE `wf_inst_hist` (
	`HIST_ID` VARCHAR(50) NOT NULL,
	`INST_ID` VARCHAR(50) NOT NULL,
	`WF_ID` VARCHAR(50) NOT NULL,
	`TASK_ID` VARCHAR(50) NOT NULL,
	`OPT_USER` VARCHAR(50) NULL DEFAULT NULL,
	`OPT_TYPE` VARCHAR(2) NULL DEFAULT NULL,
	`OPT_SEQ` INT(2) NOT NULL,
	`NEXT_ASSIGNER` VARCHAR(200) NULL DEFAULT NULL,
	`TASK_OWNER` VARCHAR(200) NULL DEFAULT NULL,
	`TASK_BEGIN` DATETIME NOT NULL,
	`TASK_END` DATETIME NULL DEFAULT NULL,
	`TASK_REND` DATETIME NOT NULL,
	`CREATED_BY` VARCHAR(50) NOT NULL,
	`CREATED_DT` DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS `wf_task` (
  ...
  `TASK_DESCP` varchar(100) DEFAULT NULL,
  ...
  `TX_TYPE` varchar(5) DEFAULT NULL,
  `BUZ_STATUS` varchar(5) DEFAULT NULL,
  `TIME_LIMIT` int(11) DEFAULT NULL,
  `TIME_LIMIT_TP` varchar(5) DEFAULT NULL,
  `ALARM_TIME` int(11) DEFAULT NULL,
  `ALARM_TIME_TP` varchar(5) DEFAULT NULL,
  `MODULE_ID` varchar(50) DEFAULT NULL,
  `Run_Param` varchar(500) DEFAULT NULL,
  `TASK_DESCP_DISP` varchar(500) DEFAULT NULL,
  `TX_CHOICES` varchar(500) DEFAULT NULL,
  `TX_PR_CHOICES` varchar(500) DEFAULT NULL,
  `TX_BK_CHOICES` varchar(500) DEFAULT NULL,
  `SIGN_CHOICES` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`TASK_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
